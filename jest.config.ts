...
const config: Config = {
    moduleNameMapper: {
        '@rogo-technologies/react-pdf-viewer-core': '<rootDir>/packages/core/src',
        '@rogo-technologies/react-pdf-viewer-default-layout': '<rootDir>/packages/default-layout/src',
